...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o lapack.so dlamch.o dlapack.o cmplx.o Lapack.o ../../extra/blas/libRblas.a /app/build/Rlibs/lib/libgfortran.a /app/build/Rlibs/lib/libc/cabs.o /app/build/Rlibs/lib/libc/csqrt.o
...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o tools.so text.o init.o Rmd5.o md5.o signals.o install.o getfmts.o http.o gramLatex.o gramRd.o pdscan.o
...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o grid.so clippath.o gpar.o grid.o just.o layout.o mask.o matrix.o register.o state.o unit.o util.o viewport.o
...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o splines.so splines.o
...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o methods.so do_substitute_direct.o init.o methods_list_dispatch.o slot.o class_support.o tests.o utils.o
...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o utils.so /app/build/Rlibs/lib/liblzma.a init.o io.o size.o sock.o stubs.o utils.o
...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o grDevices.so axis_scales.o chull.o devices.o init.o stubs.o colors.o clippath.o patterns.o mask.o devCairo.o devPicTeX.o devPS.o devQuartz.o
...
emcc -g -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o graphics.so init.o base.o graphics.o par.o plot.o plot3d.o stem.o
...
emcc  -g -std=gnu11 -Os -s WASM_BIGINT -s SIDE_MODULE=1 -o stats.so  init.o kmeans.o ansari.o bandwidths.o chisqsim.o d2x2xk.o fexact.o kendall.o ks.o line.o smooth.o prho.o swilk.o ksmooth.o loessc.o monoSpl.o isoreg.o Srunmed.o dblcen.o distance.o hclust-utils.o nls.o rWishart.o HoltWinters.o PPsum.o arima.o burg.o filter.o mAR.o pacf.o starma.o port.o family.o sbart.o approx.o loglin.o lowess.o massdist.o splines.o lm.o complete_cases.o cov.o deriv.o fft.o fourier.o model.o optim.o optimize.o integrate.o random.o distn.o zeroin.o rcont.o influence.o bsplvd.o bvalue.o bvalus.o loessf.o ppr.o qsbart.o sgram.o sinerp.o sslvrg.o stxwx.o hclust.o kmns.o eureka.o stl.o portsrc.o lminfl.o ../../../main/xxxpr.o ../../../modules/lapack/libRlapack.a ../../../extra/blas/libRblas.a /app/build/Rlibs/lib/libgfortran.a /app/build/Rlibs/lib/libc/cabs.o /app/build/Rlibs/lib/libc/csqrt.o

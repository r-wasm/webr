...
Packages for released versions of webR can be downloaded from the [releases section](https://github.com/georgestagg/webR/releases) of the webR source repository. Release packages contain both the webR JavaScript loader and the R WebAssembly binaries.
...
It is possible to build webR from source by following the build instructions at [the webR source repository](https://github.com/georgestagg/webR). Building from source creates a customised webR release package.
